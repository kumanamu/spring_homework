...
public class QuizResultController {
    ...
    public String listResults(Model model) {
        List<QuizResult> results = resultService.getAllResults();
    ...
    public String userResults(@PathVariable Long userId, Model model) {
        List<QuizResult> results = resultService.getResultsByUser(userId);
        model.addAttribute("results", results);
    ...
    // 결과 저장
    @PostMapping("/save")
    public String saveResult(@ModelAttribute QuizResult result) {
